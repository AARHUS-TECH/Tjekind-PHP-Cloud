 ...
 *
 * @forked from: https://github.com/jaytaph/TLS-decoder/tls.php
 * Note:
 *   - PHP cannot pack() 64bit numbers. Sequence numbers are limited to 32bits in our case.
 *   KRS: I have changed the code to use 64bit numbers, but it is not tested.
 * 
...
class TLS {
    ...
    protected function verify_mac($seq, $content_type, $msg, $original_mac, $hmac) {
        ...
        // -----------------
        // Cnn - (C) unsigned char, (n) unsigned short (always 16 bit, big endian byte order)
