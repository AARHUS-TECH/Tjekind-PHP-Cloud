...
<title>Tjekind PHP Cloud: http-proxy-middleware</title>
...
<h1><a class="anchor" id="autotoc_md13345"></a>
⚠️ Note &lt;!-- omit in toc --&gt;</h1>
...
<h1><a class="anchor" id="autotoc_md13346"></a>
TL;DR &lt;!-- omit in toc --&gt;</h1>
...
<h1><a class="anchor" id="autotoc_md13347"></a>
Table of Contents &lt;!-- omit in toc --&gt;</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md13348"></a>
Install</h1>
<div class="fragment"><div class="line">$ npm install --save-dev http-proxy-middleware</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md13349"></a>
Core concept</h1>
<p>Proxy middleware configuration.</p>
<h3><a class="anchor" id="autotoc_md13350"></a>
...
<h3><a class="anchor" id="autotoc_md13351"></a>
...
<h1><a class="anchor" id="autotoc_md13352"></a>
Example</h1>
...
<div class="line">app.listen(3000);</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md13353"></a>
Context matching</h1>
...
<div class="line">});</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md13354"></a>
Options</h1>
<h2><a class="anchor" id="autotoc_md13355"></a>
...
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md13356"></a>
...
<li><b>option.onClose</b>: function, subscribe to http-proxy's <code>close</code> event.</li>
</ul>
...
<li>Object: mapping of domains to new domains, use <code>"*"</code> to match all domains. <br  />
 For example keep one domain unchanged, rewrite one domain and remove other domains: ```json cookieDomainRewrite: { "unchanged.domain": "unchanged.domain", "old.domain": "new.domain", "*": "" } ``<code></code></li>
</ul>
</li>
...
<li><code>Object: mapping of paths to new paths, use</code>"*"` to match all paths. For example, to keep one path unchanged, rewrite one path and remove other paths: ```json cookiePathRewrite: { "/unchanged.path/": "/unchanged.path/", "/old.path/": "/new.path/", "*": "" } ``<code></code></li>
</ul>
</li>
...
<div class="line">  );</div>
<div class="line">};</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md13358"></a>
Shorthand</h1>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md13359"></a>
...
<h1><a class="anchor" id="autotoc_md13360"></a>
WebSocket</h1>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md13361"></a>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md13362"></a>
...
<div class="line">});</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md13363"></a>
...
<h1><a class="anchor" id="autotoc_md13364"></a>
Working examples</h1>
...
<h1><a class="anchor" id="autotoc_md13367"></a>
Tests</h1>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md13368"></a>
Changelog</h1>
<ul>
