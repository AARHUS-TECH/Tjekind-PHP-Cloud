...
<div class="contents">
<div class="textblock"><p><a href="http://travis-ci.org/tim-kos/node-retry" title="Check this project&apos;s build status on TravisCI"><object type="image/svg+xml" data="https://secure.travis-ci.org/tim-kos/node-retry.svg?branch=master" style="pointer-events: none;">Build Status</object></a> <a href="https://codecov.io/gh/tim-kos/node-retry"><object type="image/svg+xml" data="https://codecov.io/gh/tim-kos/node-retry/branch/master/graph/badge.svg" style="pointer-events: none;">codecov</object></a></p>
<h1><a class="anchor" id="autotoc_md19632"></a>
retry</h1>
<p>Abstraction for exponential and custom retry strategies for failed operations.</p>
<h2><a class="anchor" id="autotoc_md19633"></a>
Installation</h2>
<pre class="fragment">npm install retry
</pre><h2><a class="anchor" id="autotoc_md19634"></a>
Current Status</h2>
<p>This module has been tested and is ready to be used.</p>
<h2><a class="anchor" id="autotoc_md19635"></a>
Tutorial</h2>
...
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md19636"></a>
API</h2>
<h3><a class="anchor" id="autotoc_md19637"></a>
retry.operation([options])</h3>
<p>Creates a new <code>RetryOperation</code> object. <code>options</code> is the same as <code>retry.timeouts()</code>'s <code>options</code>, with three additions:</p>
<ul>
...
<h3><a class="anchor" id="autotoc_md19638"></a>
...
<h3><a class="anchor" id="autotoc_md19640"></a>
...
<h3><a class="anchor" id="autotoc_md19641"></a>
...
<h4><a class="anchor" id="autotoc_md19642"></a>
...
<h4><a class="anchor" id="autotoc_md19643"></a>
retryOperation.mainError()</h4>
<p>A reference to the error object that occured most frequently. <a class="el" href="class_errors.html">Errors</a> are compared using the <code>error.message</code> property.</p>
...
<h4><a class="anchor" id="autotoc_md19644"></a>
...
<h4><a class="anchor" id="autotoc_md19645"></a>
...
<h4><a class="anchor" id="autotoc_md19646"></a>
retryOperation.start(fn)</h4>
<p>This is an alias for <code>retryOperation.attempt(fn)</code>. This is deprecated. Please use <code>retryOperation.attempt(fn)</code> instead.</p>
<h4><a class="anchor" id="autotoc_md19647"></a>
...
<h4><a class="anchor" id="autotoc_md19648"></a>
...
<h4><a class="anchor" id="autotoc_md19649"></a>
...
<h4><a class="anchor" id="autotoc_md19650"></a>
...
<h2><a class="anchor" id="autotoc_md19651"></a>
License</h2>
