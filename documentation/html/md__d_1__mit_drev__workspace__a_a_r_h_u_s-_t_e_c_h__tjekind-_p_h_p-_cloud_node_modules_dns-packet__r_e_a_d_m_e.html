...
<title>Tjekind PHP Cloud: dns-packet</title>
...
<div class="contents">
<div class="textblock"><p><a href="https://www.npmjs.org/package/dns-packet"><object type="image/svg+xml" data="https://img.shields.io/npm/v/dns-packet.svg?style=flat" style="pointer-events: none;"></object></a> <a href="https://www.npmjs.org/package/dns-packet"><object type="image/svg+xml" data="https://img.shields.io/npm/dm/dns-packet.svg" style="pointer-events: none;"></object></a> <a href="https://github.com/github/mafintosh/dns-packet/workflows/ci.yml"><object type="image/svg+xml" data="https://github.com/github/mafintosh/dns-packet/workflows/ci.yml/badge.svg" style="pointer-events: none;"></object></a> <a href="https://coveralls.io/github/mafintosh/dns-packet?branch=master"><object type="image/svg+xml" data="https://coveralls.io/repos/github/mafintosh/dns-packet/badge.svg?branch=master" style="pointer-events: none;">Coverage Status</object></a></p>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md8007"></a>
UDP Usage</h1>
<div class="fragment"><div class="line">const dnsPacket = require(&#39;dns-packet&#39;)</div>
...
<h1><a class="anchor" id="autotoc_md8008"></a>
TCP, TLS, HTTPS</h1>
...
<div class="line">}</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md8016"></a>
Supported record types</h1>
<h3><a class="anchor" id="autotoc_md8017"></a>
&lt;tt&gt;A&lt;/tt&gt;</h3>
<div class="fragment"><div class="line">{</div>
<div class="line">  data: &#39;IPv4 address&#39; // fx 127.0.0.1</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8018"></a>
&lt;tt&gt;AAAA&lt;/tt&gt;</h3>
<div class="fragment"><div class="line">{</div>
<div class="line">  data: &#39;IPv6 address&#39; // fx fe80::1</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8019"></a>
&lt;tt&gt;CAA&lt;/tt&gt;</h3>
<div class="fragment"><div class="line">{</div>
...
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8020"></a>
&lt;tt&gt;CNAME&lt;/tt&gt;</h3>
<div class="fragment"><div class="line">{</div>
<div class="line">  data: &#39;cname.to.another.record&#39;</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8021"></a>
&lt;tt&gt;DNAME&lt;/tt&gt;</h3>
<div class="fragment"><div class="line">{</div>
<div class="line">  data: &#39;dname.to.another.record&#39;</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8022"></a>
&lt;tt&gt;DNSKEY&lt;/tt&gt;</h3>
<div class="fragment"><div class="line">{</div>
...
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8023"></a>
&lt;tt&gt;DS&lt;/tt&gt;</h3>
<div class="fragment"><div class="line">{</div>
...
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8024"></a>
&lt;tt&gt;HINFO&lt;/tt&gt;</h3>
<div class="fragment"><div class="line">{</div>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8025"></a>
&lt;tt&gt;MX&lt;/tt&gt;</h3>
<div class="fragment"><div class="line">{</div>
<div class="line">  preference: 10,</div>
<div class="line">  exchange: &#39;mail.example.net&#39;</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8026"></a>
&lt;tt&gt;NS&lt;/tt&gt;</h3>
<div class="fragment"><div class="line">{</div>
<div class="line">  data: nameServer</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8027"></a>
&lt;tt&gt;NSEC&lt;/tt&gt;</h3>
<div class="fragment"><div class="line">{</div>
<div class="line">  nextDomain: &#39;a.domain&#39;,</div>
<div class="line">  rrtypes: [&#39;A&#39;, &#39;TXT&#39;, &#39;RRSIG&#39;]</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8028"></a>
&lt;tt&gt;NSEC3&lt;/tt&gt;</h3>
<div class="fragment"><div class="line">{</div>
...
<div class="line">  rrtypes: [&#39;A&#39;, &#39;TXT&#39;, &#39;RRSIG&#39;]</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8029"></a>
&lt;tt&gt;NULL&lt;/tt&gt;</h3>
<div class="fragment"><div class="line">{</div>
<div class="line">  data: Buffer(&#39;any binary data&#39;)</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8030"></a>
&lt;tt&gt;OPT&lt;/tt&gt;</h3>
...
<h3><a class="anchor" id="autotoc_md8031"></a>
&lt;tt&gt;PTR&lt;/tt&gt;</h3>
<div class="fragment"><div class="line">{</div>
<div class="line">  data: &#39;points.to.another.record&#39;</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8032"></a>
&lt;tt&gt;RP&lt;/tt&gt;</h3>
<div class="fragment"><div class="line">{</div>
<div class="line">  mbox: &#39;admin.example.com&#39;,</div>
<div class="line">  txt: &#39;txt.example.com&#39;</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8033"></a>
&lt;tt&gt;SSHFP&lt;/tt&gt;</h3>
<p>``` js { algorithm: 1, hash: 1, fingerprint: 'A108C9F834354D5B37AF988141C9294822F5BC00' } ````</p>
<h3><a class="anchor" id="autotoc_md8034"></a>
&lt;tt&gt;RRSIG&lt;/tt&gt;</h3>
<div class="fragment"><div class="line">{</div>
<div class="line">  typeCovered: &#39;A&#39;,</div>
<div class="line">  algorithm: 8,</div>
<div class="line">  labels: 1,</div>
<div class="line">  originalTTL: 3600,</div>
<div class="line">  expiration: timestamp,</div>
<div class="line">  inception: timestamp,</div>
<div class="line">  keyTag: 12345,</div>
<div class="line">  signersName: &#39;a.name&#39;,</div>
<div class="line">  signature: Buffer</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8035"></a>
&lt;tt&gt;SOA&lt;/tt&gt;</h3>
<div class="fragment"><div class="line">{</div>
<div class="line">  data:</div>
<div class="line">    {</div>
...
<div class="line">    }</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8036"></a>
&lt;tt&gt;SRV&lt;/tt&gt;</h3>
<div class="fragment"><div class="line">{</div>
<div class="line">  data: {</div>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8037"></a>
&lt;tt&gt;TXT&lt;/tt&gt;</h3>
<div class="fragment"><div class="line">{</div>
<div class="line">  data: &#39;text&#39; || Buffer || [ Buffer || &#39;text&#39; ]</div>
<div class="line">}</div>
</div><!-- fragment --><p>When encoding, scalar values are converted to an array and strings are converted to UTF-8 encoded Buffers. When decoding, the return value will always be an array of Buffer.</p>
<p>If you need another record type, open an issue and we'll try to add it.</p>
<h1><a class="anchor" id="autotoc_md8038"></a>
License</h1>
<p>MIT </p>
</div></div><!-- contents -->
</div><!-- PageDoc -->
