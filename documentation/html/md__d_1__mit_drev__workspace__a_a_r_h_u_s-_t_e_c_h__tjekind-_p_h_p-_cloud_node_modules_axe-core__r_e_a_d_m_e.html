...
<title>Tjekind PHP Cloud: axe-core</title>
...
<div class="title">axe-core </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><p>[<object type="image/svg+xml" data="https://img.shields.io/npm/l/axe-core.svg" style="pointer-events: none;">License</object>](LICENSE) <a href="https://www.npmjs.com/package/axe-core"><object type="image/svg+xml" data="https://img.shields.io/npm/v/axe-core.svg" style="pointer-events: none;">Version</object></a> <a href="https://www.npmjs.com/package/axe-core"><object type="image/svg+xml" data="https://img.shields.io/npm/dt/axe-core.svg" style="pointer-events: none;">Total npm downloads</object></a> <a href="https://github.com/dequelabs/axe-core/commits/develop"><object type="image/svg+xml" data="https://img.shields.io/github/commit-activity/y/dequelabs/axe-core.svg" style="pointer-events: none;">Commits</object></a> <a href="https://github.com/dequelabs/axe-core/graphs/contributors"><object type="image/svg+xml" data="https://img.shields.io/github/contributors/dequelabs/axe-core.svg" style="pointer-events: none;">GitHub contributors</object></a> <a href="https://accessibility.deque.com/axe-community"><object type="image/svg+xml" data="https://img.shields.io/badge/slack-chat-purple.svg?logo=slack" style="pointer-events: none;">Join our Slack chat</object></a> <a href="https://packagequality.com/#?package=axe-core"><object type="image/svg+xml" data="https://npm.packagequality.com/shield/axe-core.svg" style="pointer-events: none;">Package Quality</object></a></p>
...
<h1><a class="anchor" id="autotoc_md5007"></a>
The Accessibility Rules</h1>
...
<p>With axe-core, you can find <b>on average 57% of WCAG issues automatically</b>. Additionally, axe-core will return elements as "incomplete" where axe-core could not be certain, and manual review is needed.</p>
...
<p>The complete list of rules, grouped WCAG level and best practice, can found in doc/rule-descriptions.md.</p>
<h1><a class="anchor" id="autotoc_md5008"></a>
Getting started</h1>
<p>First download the package:</p>
<div class="fragment"><div class="line">npm install axe-core --save-dev</div>
</div><!-- fragment --><p>Now include the javascript file in each of your iframes in your fixtures or test systems:</p>
<div class="fragment"><div class="line">&lt;script src=&quot;node_modules/axe-core/axe.min.js&quot;&gt;&lt;/script&gt;</div>
</div><!-- fragment --><p>Now insert calls at each point in your tests where a new piece of UI becomes visible or exposed:</p>
<div class="fragment"><div class="line">axe</div>
<div class="line">  .run()</div>
<div class="line">  .then(results =&gt; {</div>
<div class="line">    if (results.violations.length) {</div>
<div class="line">      throw new Error(&#39;Accessibility issues found&#39;);</div>
<div class="line">    }</div>
<div class="line">  })</div>
<div class="line">  .catch(err =&gt; {</div>
<div class="line">    console.error(&#39;Something bad happened:&#39;, err.message);</div>
<div class="line">  });</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md5009"></a>
Philosophy</h1>
...
<h1><a class="anchor" id="autotoc_md5010"></a>
About axe - our Manifesto</h1>
<ul>
...
Supported Browsers</h1>
<p>The axe-core API fully supports the following browsers:</p>
<ul>
...
<h1><a class="anchor" id="autotoc_md5012"></a>
Contents of the API Package</h1>
<p>The axe-core API package consists of:</p>
<ul>
...
<div class="fragment"><div class="line">axe.configure({</div>
<div class="line">  locale: {</div>
<div class="line">    lang: &#39;de&#39;,</div>
<div class="line">    rules: {</div>
<div class="line">      accesskeys: {</div>
<div class="line">        help: &#39;Der Wert des accesskey-Attributes muss einzigartig sein.&#39;</div>
<div class="line">      }</div>
<div class="line">      // ...</div>
<div class="line">    },</div>
<div class="line">    checks: {</div>
<div class="line">      abstractrole: {</div>
<div class="line">        fail: &#39;Abstrakte ARIA-Rollen dürfen nicht direkt verwendet werden.&#39;</div>
<div class="line">      },</div>
<div class="line">      &#39;aria-errormessage&#39;: {</div>
<div class="line">        // Note: doT (https://github.com/olado/dot) templates are supported here.</div>
<div class="line">        fail: &#39;Der Wert der aria-errormessage ${data.values}` muss eine Technik verwenden, um die Message anzukündigen (z. B., aria-live, aria-describedby, role=alert, etc.).&#39;</div>
<div class="line">      }</div>
<div class="line">      // ...</div>
<div class="line">    }</div>
<div class="line">  }</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md5014"></a>
Supported Locales</h2>
...
<h1><a class="anchor" id="autotoc_md5015"></a>
Updates &amp; Security</h1>
<p>Axe-core has a new minor release every 3 to 5 months, which usually introduces new rules and features. We recommend scheduling time to upgrade to these versions. Security updates will be made available for minor version lines up to <b>18 months old</b>.</p>
<ul>
<li>See release and support for details on the frequency of releases, long-term support and recommendations on upgrading axe-core.</li>
<li>See backward compatibility for details on the types of changes different releases may introduce.</li>
</ul>
<h1><a class="anchor" id="autotoc_md5016"></a>
Supported ARIA Roles and Attributes.</h1>
<p>Refer axe-core ARIA support for a complete list of ARIA supported roles and attributes by axe.</p>
<h1><a class="anchor" id="autotoc_md5017"></a>
Contributing</h1>
<p>Read the Proposing Axe-core Rules guide</p>
<p>Read the documentation on the architecture</p>
<p>Read the <a class="el" href="uuid_2_c_o_n_t_r_i_b_u_t_i_n_g_8md.html">documentation on contributing</a></p>
<h1><a class="anchor" id="autotoc_md5018"></a>
Projects using axe-core</h1>
<p>List of projects using axe-core</p>
