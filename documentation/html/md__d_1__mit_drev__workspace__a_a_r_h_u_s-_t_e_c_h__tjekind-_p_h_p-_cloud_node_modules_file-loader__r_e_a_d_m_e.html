...
<div class="contents">
<div class="textblock"><div align="center"> <a href="https://github.com/webpack/webpack"><object type="image/svg+xml" data="https://webpack.js.org/assets/icon-square-big.svg" style="pointer-events: none;" width="200" height="200"></object> </a> </div><p><a href="https://npmjs.com/package/file-loader"><object type="image/svg+xml" data="https://img.shields.io/npm/v/file-loader.svg" style="pointer-events: none;">npm</object></a> <a href="https://nodejs.org"><object type="image/svg+xml" data="https://img.shields.io/node/v/file-loader.svg" style="pointer-events: none;">node</object></a> <a href="https://david-dm.org/webpack-contrib/file-loader"><object type="image/svg+xml" data="https://david-dm.org/webpack-contrib/file-loader.svg" style="pointer-events: none;">deps</object></a> <a href="https://github.com/webpack-contrib/file-loader/actions"><object type="image/svg+xml" data="https://github.com/webpack-contrib/file-loader/workflows/file-loader/badge.svg" style="pointer-events: none;">tests</object></a> <a href="https://codecov.io/gh/webpack-contrib/file-loader"><object type="image/svg+xml" data="https://codecov.io/gh/webpack-contrib/file-loader/branch/master/graph/badge.svg" style="pointer-events: none;">coverage</object></a> <a href="https://gitter.im/webpack/webpack"><object type="image/svg+xml" data="https://img.shields.io/badge/gitter-webpack%2Fwebpack-brightgreen.svg" style="pointer-events: none;">chat</object></a> <a href="https://packagephobia.now.sh/result?p=file-loader"><img src="https://packagephobia.now.sh/badge?p=file-loader" alt="size" class="inline"/></a></p>
<h1><a class="anchor" id="autotoc_md11480"></a>
file-loader</h1>
...
<h2><a class="anchor" id="autotoc_md11481"></a>
Getting Started</h2>
...
<h2><a class="anchor" id="autotoc_md11482"></a>
Options</h2>
<h3><a class="anchor" id="autotoc_md11483"></a>
&lt;tt&gt;name&lt;/tt&gt;</h3>
...
<h4><a class="anchor" id="autotoc_md11484"></a>
&lt;tt&gt;String&lt;/tt&gt;</h4>
<p><b>webpack.config.js</b></p>
<div class="fragment"><div class="line">module.exports = {</div>
<div class="line">  module: {</div>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md11485"></a>
&lt;tt&gt;Function&lt;/tt&gt;</h4>
<p><b>webpack.config.js</b></p>
<p>```js module.exports = { module: { rules: [ { test: /.(png|jpe?g|gif)$/i, loader: 'file-loader', options: { name(resourcePath, resourceQuery) { // <code>resourcePath</code> - <code>/absolute/path/to/file.js</code> // <code>resourceQuery</code> - <code>?foo=bar</code></p>
<p>if (process.env.NODE_ENV === 'development') { return '[path][name].[ext]'; }</p>
<p>return '[contenthash].[ext]'; }, }, }, ], }, }; ```</p>
<blockquote class="doxtable">
...
<h3><a class="anchor" id="autotoc_md11486"></a>
&lt;tt&gt;outputPath&lt;/tt&gt;</h3>
...
<h4><a class="anchor" id="autotoc_md11487"></a>
&lt;tt&gt;String&lt;/tt&gt;</h4>
<p><b>webpack.config.js</b></p>
<div class="fragment"><div class="line">module.exports = {</div>
<div class="line">  module: {</div>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md11488"></a>
&lt;tt&gt;Function&lt;/tt&gt;</h4>
<p><b>webpack.config.js</b></p>
<div class="fragment"><div class="line">module.exports = {</div>
<div class="line">  module: {</div>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md11489"></a>
&lt;tt&gt;publicPath&lt;/tt&gt;</h3>
...
<h4><a class="anchor" id="autotoc_md11490"></a>
&lt;tt&gt;String&lt;/tt&gt;</h4>
<p><b>webpack.config.js</b></p>
<div class="fragment"><div class="line">module.exports = {</div>
<div class="line">  module: {</div>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md11491"></a>
&lt;tt&gt;Function&lt;/tt&gt;</h4>
<p><b>webpack.config.js</b></p>
<div class="fragment"><div class="line">module.exports = {</div>
<div class="line">  module: {</div>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md11492"></a>
&lt;tt&gt;postTransformPublicPath&lt;/tt&gt;</h3>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md11493"></a>
&lt;tt&gt;context&lt;/tt&gt;</h3>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md11494"></a>
&lt;tt&gt;emitFile&lt;/tt&gt;</h3>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md11495"></a>
&lt;tt&gt;regExp&lt;/tt&gt;</h3>
...
<h3><a class="anchor" id="autotoc_md11496"></a>
&lt;tt&gt;esModule&lt;/tt&gt;</h3>
<p>Type: <code>Boolean</code> Default: <code>true</code></p>
...
&lt;tt&gt;[contenthash]&lt;/tt&gt;</h3>
<p>Type: <code>String</code> Default: <code>md4</code></p>
<p>Specifies the hash method to use for hashing the file content.</p>
<h3><a class="anchor" id="autotoc_md11507"></a>
&lt;tt&gt;[&lt;hashType&gt;:hash:&lt;digestType&gt;:&lt;length&gt;]&lt;/tt&gt;</h3>
...
<h4><a class="anchor" id="autotoc_md11509"></a>
&lt;tt&gt;hashType&lt;/tt&gt;</h4>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md11516"></a>
CDN</h3>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md11517"></a>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md11518"></a>
Contributing</h2>
...
<h2><a class="anchor" id="autotoc_md11519"></a>
License</h2>
