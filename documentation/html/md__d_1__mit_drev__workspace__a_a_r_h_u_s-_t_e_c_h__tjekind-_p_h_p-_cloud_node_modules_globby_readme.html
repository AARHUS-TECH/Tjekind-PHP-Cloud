...
<title>Tjekind PHP Cloud: globby</title>
...
<div class="title">globby </div>  </div>
</div><!--header-->
<div class="contents">
...
<h1><a class="anchor" id="autotoc_md12525"></a>
Features</h1>
<ul>
<li>Promise API</li>
...
<li><code>Supports</code>.gitignore`</li>
</ul>
<h1><a class="anchor" id="autotoc_md12526"></a>
Install</h1>
<div class="fragment"><div class="line">$ npm install globby</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md12527"></a>
Usage</h1>
...
<div class="line">})();</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md12528"></a>
API</h1>
...
<h3><a class="anchor" id="autotoc_md12531"></a>
options</h3>
...
<h4><a class="anchor" id="autotoc_md12532"></a>
...
<div class="fragment"><div class="line">const globby = require(&#39;globby&#39;);</div>
<div class="line"> </div>
<div class="line">(async () =&gt; {</div>
...
<h4><a class="anchor" id="autotoc_md12533"></a>
gitignore</h4>
...
<h2><a class="anchor" id="autotoc_md12534"></a>
globby.sync(patterns, options?)</h2>
<p>Returns <code>string[]</code> of matching paths.</p>
<h2><a class="anchor" id="autotoc_md12535"></a>
globby.stream(patterns, options?)</h2>
...
<div class="line"> </div>
<div class="line">(async () =&gt; {</div>
<div class="line">    for await (const path of globby.stream(&#39;*.tmp&#39;)) {</div>
<div class="line">        console.log(path);</div>
<div class="line">    }</div>
<div class="line">})();</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md12536"></a>
...
<h2><a class="anchor" id="autotoc_md12537"></a>
...
<h2><a class="anchor" id="autotoc_md12538"></a>
globby.gitignore(options?)</h2>
...
<div class="fragment"><div class="line">const {gitignore} = require(&#39;globby&#39;);</div>
<div class="line"> </div>
<div class="line">(async () =&gt; {</div>
<div class="line">    const isIgnored = await gitignore();</div>
<div class="line">    console.log(isIgnored(&#39;some/file&#39;));</div>
<div class="line">})();</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md12539"></a>
globby.gitignore.sync(options?)</h2>
