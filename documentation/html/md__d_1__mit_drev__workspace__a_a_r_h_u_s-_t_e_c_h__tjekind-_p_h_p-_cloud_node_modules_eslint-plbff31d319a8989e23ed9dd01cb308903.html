...
<title>Tjekind PHP Cloud: Require setup and teardown code to be within a hook (&lt;tt&gt;require-hook&lt;/tt&gt;)</title>
...
<div class="title">Require setup and teardown code to be within a hook (<code>require-hook</code>) </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><p>Often while writing tests you have some setup work that needs to happen before tests run, and you have some finishing work that needs to happen after tests run. Jest provides helper functions to handle this.</p>
...
<div class="line">  clearCityDatabase();</div>
<div class="line">});</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md10049"></a>
Options</h1>
