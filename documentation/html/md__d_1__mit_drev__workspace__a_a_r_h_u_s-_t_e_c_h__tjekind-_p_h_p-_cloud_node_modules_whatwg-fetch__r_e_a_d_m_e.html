...
<title>Tjekind PHP Cloud: window.fetch polyfill</title>
...
<h1><a class="anchor" id="autotoc_md25148"></a>
...
<h1><a class="anchor" id="autotoc_md25149"></a>
Read this first</h1>
<ul>
<li>If you believe you found a bug with how <code>fetch</code> behaves in your browser, please <b>don't open an issue in this repository</b> unless you are testing in an old version of a browser that doesn't support <code>window.fetch</code> natively. Make sure you read this <em>entire</em> readme, especially the <a href="#caveats">Caveats</a> section, as there's probably a known work-around for an issue you've found. This project is a <em>polyfill</em>, and since all modern browsers now implement the <code>fetch</code> function natively, <b>no code from this project</b> actually takes any effect there. See <a href="#browser-support">Browser support</a> for detailed information.</li>
...
<h1><a class="anchor" id="autotoc_md25150"></a>
Installation</h1>
<div class="fragment"><div class="line">npm install whatwg-fetch --save</div>
</div><!-- fragment --><p>As an alternative to using npm, you can obtain <code>fetch.umd.js</code> from the <a href="https://github.com/github/fetch/releases">Releases</a> section. The UMD distribution is compatible with AMD and CommonJS module loaders, as well as loading directly into a page via <code>&lt;script&gt;</code> tag.</p>
...
<h1><a class="anchor" id="autotoc_md25151"></a>
Usage</h1>
...
<h2><a class="anchor" id="autotoc_md25152"></a>
Importing</h2>
...
</div><!-- fragment --><p>This approach can be used to, for example, use <a href="#aborting-requests">abort functionality</a> in browsers that implement a native but outdated version of fetch that doesn't support aborting.</p>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md25153"></a>
HTML</h2>
...
<div class="line">  })</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md25154"></a>
JSON</h2>
...
<div class="line">  })</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md25155"></a>
...
<div class="line">})</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md25156"></a>
Post form</h2>
...
<div class="line">})</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md25157"></a>
Post JSON</h2>
...
<div class="line">  })</div>
<div class="line">})</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md25158"></a>
File upload</h2>
...
<div class="line">})</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md25159"></a>
Caveats</h2>
<ul>
...
<li>For maximum browser compatibility when it comes to sending &amp; receiving cookies, always supply the &lsquo;credentials: 'same-origin&rsquo;` option instead of relying on the default. See <a href="#sending-cookies">Sending cookies</a>.</li>
<li>Not all Fetch standard options are supported in this polyfill. For instance, <a href="#redirect-modes"><code>redirect</code></a> and <a href="https://github.github.io/fetch/#caveats"><code>cache</code></a> directives are ignored.</li>
...
<h3><a class="anchor" id="autotoc_md25160"></a>
...
<div class="line">  })</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md25161"></a>
Sending cookies</h3>
...
<h3><a class="anchor" id="autotoc_md25162"></a>
...
<h3><a class="anchor" id="autotoc_md25163"></a>
Redirect modes</h3>
...
<h3><a class="anchor" id="autotoc_md25164"></a>
...
<div class="fragment"><div class="line"># Ruby on Rails controller example</div>
...
<h3><a class="anchor" id="autotoc_md25165"></a>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md25166"></a>
Browser Support</h1>
<ul>
<li>Chrome</li>
<li>Firefox</li>
