...
<h2><a class="anchor" id="autotoc_md23767"></a>
Getting Started</h2>
...
<h2><a class="anchor" id="autotoc_md23768"></a>
...
<h2><a class="anchor" id="autotoc_md23769"></a>
Options</h2>
<ul>
...
<li>**<a href="#terseroptions"><code>terserOptions</code></a>**</li>
<li>**<a href="#extractcomments"><code>extractComments</code></a>**</li>
</ul>
<h3><a class="anchor" id="autotoc_md23770"></a>
&lt;tt&gt;test&lt;/tt&gt;</h3>
<p>Type:</p>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md23771"></a>
&lt;tt&gt;include&lt;/tt&gt;</h3>
<p>Type:</p>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md23772"></a>
&lt;tt&gt;exclude&lt;/tt&gt;</h3>
<p>Type:</p>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md23773"></a>
&lt;tt&gt;parallel&lt;/tt&gt;</h3>
<p>Type:</p>
...
<h4><a class="anchor" id="autotoc_md23774"></a>
&lt;tt&gt;boolean&lt;/tt&gt;</h4>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md23775"></a>
&lt;tt&gt;number&lt;/tt&gt;</h4>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md23776"></a>
&lt;tt&gt;minify&lt;/tt&gt;</h3>
<p>Type:</p>
...
<p><b>webpack.config.js</b></p>
<p>```js // Can be async const minify = (input, sourceMap, minimizerOptions, extractsComments) =&gt; { // The <code>minimizerOptions</code> option contains option from the <code>terserOptions</code> option // You can use <code>minimizerOptions.myCustomOption</code></p>
<p>// Custom logic for extract comments const { map, code } = require("uglify-module") // Or require('./path/to/uglify-module') .minify(input, { /* Your options for minification */ });</p>
<p>return { map, code, warnings: [], errors: [], extractedComments: [] }; };</p>
<p>// Used to regenerate <code>fullhash</code>/<code>chunkhash</code> between different implementation // Example: you fix a bug in custom minimizer/custom function, but unfortunately webpack doesn't know about it, so you will get the same fullhash/chunkhash // to avoid this you can provide version of your custom minimizer // You don't need if you use only <code>contenthash</code> minify.getMinimizerVersion = () =&gt; { let packageJson;</p>
<p>try { // eslint-disable-next-line global-require, import/no-extraneous-dependencies packageJson = require("uglify-module/package.json"); } catch (error) { // Ignore }</p>
<p>return packageJson &amp;&amp; packageJson.version; };</p>
<p>module.exports = { optimization: { minimize: true, minimizer: [ new TerserPlugin({ terserOptions: { myCustomOption: true, }, minify, }), ], }, }; ```</p>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md23778"></a>
...
<h4><a class="anchor" id="autotoc_md23779"></a>
&lt;tt&gt;boolean&lt;/tt&gt;</h4>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md23780"></a>
&lt;tt&gt;string&lt;/tt&gt;</h4>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md23781"></a>
&lt;tt&gt;RegExp&lt;/tt&gt;</h4>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md23782"></a>
&lt;tt&gt;function&lt;/tt&gt;</h4>
<p>All comments that match the given expression will be extracted to the separate file.</p>
<p><b>webpack.config.js</b></p>
<div class="fragment"><div class="line">module.exports = {</div>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md23783"></a>
&lt;tt&gt;object&lt;/tt&gt;</h4>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><p><a class="anchor" id="autotoc_md23784"></a></p><h5><code>condition</code></h5>
<p>Type:</p>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><p><a class="anchor" id="autotoc_md23785"></a></p><h5><code>filename</code></h5>
<p>Type:</p>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><p><a class="anchor" id="autotoc_md23786"></a></p><h5><code>banner</code></h5>
<p>Type:</p>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md23787"></a>
Examples</h2>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md23789"></a>
Remove Comments</h3>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md23790"></a>
&lt;a href="https://github.com/mishoo/UglifyJS"&gt;&lt;tt&gt;uglify-js&lt;/tt&gt;&lt;/a&gt;</h3>
...
<p><b>webpack.config.js</b></p>
<p>```js module.exports = { optimization: { minimize: true, minimizer: [ new TerserPlugin({ minify: TerserPlugin.uglifyJsMinify, // <code>terserOptions</code> options will be passed to <code>uglify-js</code> // Link to options - <a href="https://github.com/mishoo/UglifyJS#minify-options">https://github.com/mishoo/UglifyJS#minify-options</a> terserOptions: {}, }), ], }, }; </p><div class="fragment"><div class="line">### [`swc`](https://github.com/swc-project/swc)</div>
<div class="line"> </div>
<div class="line">[`swc`](https://github.com/swc-project/swc) is a super-fast compiler written in rust; producing widely-supported javascript from modern standards and typescript.</div>
<div class="line"> </div>
<div class="line">&gt; **Warning**</div>
<div class="line">&gt;</div>
<div class="line">&gt; the `extractComments` option is not supported and all comments will be removed by default, it will be fixed in future</div>
<div class="line"> </div>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md23791"></a>
&lt;a href="https://github.com/evanw/esbuild"&gt;&lt;tt&gt;esbuild&lt;/tt&gt;&lt;/a&gt;</h3>
...
<p><b>webpack.config.js</b></p>
<p>```js module.exports = { optimization: { minimize: true, minimizer: [ new TerserPlugin({ minify: TerserPlugin.esbuildMinify, // <code>terserOptions</code> options will be passed to <code>esbuild</code> // Link to options - <a href="https://esbuild.github.io/api/#minify">https://esbuild.github.io/api/#minify</a> // Note: the <code>minify</code> options is true by default (and override other <code>minify*</code> options), so if you want to disable the <code>minifyIdentifiers</code> option (or other <code>minify*</code> options) please use: // terserOptions: { // minify: false, // minifyWhitespace: true, // minifyIdentifiers: false, // minifySyntax: true, // }, terserOptions: {}, }), ], }, }; </p><div class="fragment"><div class="line">### Custom Minify Function</div>
<div class="line"> </div>
<div class="line">Override default minify function - use `uglify-js` for minification.</div>
<div class="line"> </div>
<div class="line">**webpack.config.js**</div>
<div class="line"> </div>
<div class="line">```js</div>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md23792"></a>
Typescript</h3>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md23793"></a>
Contributing</h2>
...
<h2><a class="anchor" id="autotoc_md23794"></a>
License</h2>
