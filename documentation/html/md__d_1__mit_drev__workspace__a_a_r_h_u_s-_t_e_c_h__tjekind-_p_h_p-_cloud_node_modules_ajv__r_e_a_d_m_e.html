...
<div class="contents">
<div class="textblock"><p><img src="https://ajv.js.org/images/ajv_logo.png" alt="Ajv logo" align="right" width="160" class="inline"/></p>
...
<p><a href="https://travis-ci.org/ajv-validator/ajv"><object type="image/svg+xml" data="https://travis-ci.org/ajv-validator/ajv.svg?branch=master" style="pointer-events: none;">Build Status</object></a> <a href="https://www.npmjs.com/package/ajv"><object type="image/svg+xml" data="https://img.shields.io/npm/v/ajv.svg" style="pointer-events: none;">npm</object></a> <a href="https://www.npmjs.com/package/ajv/v/7.0.0-beta.0"><img src="https://img.shields.io/npm/v/ajv/beta" alt="npm (beta)" class="inline"/></a> <a href="https://www.npmjs.com/package/ajv"><object type="image/svg+xml" data="https://img.shields.io/npm/dm/ajv.svg" style="pointer-events: none;">npm downloads</object></a> <a href="https://coveralls.io/github/ajv-validator/ajv?branch=master"><object type="image/svg+xml" data="https://coveralls.io/repos/github/ajv-validator/ajv/badge.svg?branch=master" style="pointer-events: none;">Coverage Status</object></a> <a href="https://gitter.im/ajv-validator/ajv"><object type="image/svg+xml" data="https://img.shields.io/gitter/room/ajv-validator/ajv.svg" style="pointer-events: none;">Gitter</object></a> <a href="https://github.com/sponsors/epoberezkin"><img src="https://img.shields.io/badge/$-sponsors-brightgreen" alt="GitHub Sponsors" class="inline"/></a></p>
<h2><a class="anchor" id="autotoc_md4563"></a>
Ajv v7 beta is released</h2>
<p><a href="https://github.com/ajv-validator/ajv/tree/v7-beta">Ajv version 7.0.0-beta.0</a> is released with these changes:</p>
<ul>
<li>to reduce the mistakes in JSON schemas and unexpected validation results, strict mode is added - it prohibits ignored or ambiguous JSON Schema elements.</li>
<li>to make code injection from untrusted schemas impossible, code generation is fully re-written to be safe.</li>
...
<div class="fragment"><div class="line">npm install ajv@beta</div>
</div><!-- fragment --><p>See <a href="https://github.com/ajv-validator/ajv/tree/v7-beta#usage">Getting started with v7</a> for code example.</p>
<h2><a class="anchor" id="autotoc_md4564"></a>
Mozilla MOSS grant and OpenJS Foundation</h2>
<p><a href="https://www.mozilla.org/en-US/moss/"><img src="https://www.poberezkin.com/images/mozilla.png" alt="" width="240" height="68" class="inline"/></a> &#160;&#160;&#160; <a href="https://openjsf.org/blog/2020/08/14/ajv-joins-openjs-foundation-as-an-incubation-project/"><img src="https://www.poberezkin.com/images/openjs.png" alt="" width="220" height="68" class="inline"/></a></p>
...
<h2><a class="anchor" id="autotoc_md4565"></a>
Please &lt;a href="https://github.com/sponsors/epoberezkin"&gt;sponsor Ajv development&lt;/a&gt;</h2>
...
<p>Thank you.</p>
<h4><a class="anchor" id="autotoc_md4566"></a>
...
<h2><a class="anchor" id="autotoc_md4567"></a>
Using version 6</h2>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md4568"></a>
Contents</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md4569"></a>
Performance</h2>
...
Features</h2>
<ul>
<li>Ajv implements full JSON Schema <a href="http://json-schema.org/">draft-06/07</a> and draft-04 standards:<ul>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md4572"></a>
...
<h2><a class="anchor" id="autotoc_md4573"></a>
Using in browser</h2>
...
<p><b>Please note</b>: some frameworks, e.g. Dojo, may redefine global require in such way that is not compatible with CommonJS module format. In such case Ajv bundle has to be loaded before the framework and then you can use global Ajv (see issue <a href="https://github.com/ajv-validator/ajv/issues/234">#234</a>).</p>
<h3><a class="anchor" id="autotoc_md4574"></a>
Ajv and Content Security Policies (CSP)</h3>
<p>If you're using Ajv to compile a schema (the typical use) in a browser document that is loaded with a Content Security Policy (CSP), that policy will require a <code>script-src</code> directive that includes the value &lsquo;'unsafe-eval&rsquo;<code>. :warning: NOTE, however, that</code>unsafe-eval` is NOT recommended in a secure CSP<a href="https://developer.chrome.com/extensions/contentSecurityPolicy#relaxing-eval">[1]</a>, as it has the potential to open the document to cross-site scripting (XSS) attacks.</p>
...
<h2><a class="anchor" id="autotoc_md4575"></a>
...
<h2><a class="anchor" id="autotoc_md4576"></a>
...
<h2><a class="anchor" id="autotoc_md4577"></a>
...
<h2><a class="anchor" id="autotoc_md4578"></a>
Formats</h2>
...
<h2><a class="anchor" id="autotoc_md4579"></a>
...
<h2><a class="anchor" id="autotoc_md4580"></a>
$data reference</h2>
...
<h2><a class="anchor" id="autotoc_md4581"></a>
...
<h2><a class="anchor" id="autotoc_md4582"></a>
...
</div><!-- fragment --><p>Several custom keywords (typeof, instanceof, range and propertyNames) are defined in <a href="https://github.com/ajv-validator/ajv-keywords">ajv-keywords</a> package - they can be used for your schemas and as a starting point for your own custom keywords.</p>
<p>See <a href="https://github.com/ajv-validator/ajv/blob/master/CUSTOM.md">Defining custom keywords</a> for more details.</p>
<h2><a class="anchor" id="autotoc_md4583"></a>
...
<h2><a class="anchor" id="autotoc_md4584"></a>
...
<div class="line">});</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md4585"></a>
...
<h4><a class="anchor" id="autotoc_md4586"></a>
Using nodent</h4>
<div class="fragment"><div class="line">var ajv = new Ajv;</div>
<div class="line">require(&#39;ajv-async&#39;)(ajv);</div>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md4587"></a>
...
<h2><a class="anchor" id="autotoc_md4588"></a>
...
<p><a class="anchor" id="autotoc_md4589"></a></p><h5>Security contact</h5>
...
<p><a class="anchor" id="autotoc_md4590"></a></p><h5>Untrusted schemas</h5>
...
<p><a class="anchor" id="autotoc_md4591"></a></p><h5>Circular references in JavaScript objects</h5>
...
<p><a class="anchor" id="autotoc_md4592"></a></p><h5>Security risks of trusted schemas</h5>
...
<p><a class="anchor" id="autotoc_md4593"></a></p><h5>Content Security Policies (CSP)</h5>
<p>See <a href="#ajv-and-content-security-policies-csp">Ajv and Content Security Policies (CSP)</a></p>
<h2><a class="anchor" id="autotoc_md4594"></a>
ReDoS attack</h2>
...
<p><b>Please note</b>: some formats that Ajv implements use <a href="https://github.com/ajv-validator/ajv/blob/master/lib/compile/formats.js">regular expressions</a> that can be vulnerable to ReDoS attack, so if you use Ajv to validate data from untrusted sources <b>it is strongly recommended</b> to consider the following:</p>
<ul>
...
<h2><a class="anchor" id="autotoc_md4595"></a>
Filtering data</h2>
...
<h2><a class="anchor" id="autotoc_md4596"></a>
...
<h2><a class="anchor" id="autotoc_md4597"></a>
...
<h2><a class="anchor" id="autotoc_md4598"></a>
API</h2>
<p><a class="anchor" id="autotoc_md4599"></a></p><h5>new Ajv(Object options) -&gt; Object</h5>
<p>Create Ajv instance.</p>
<p><a class="anchor" id="autotoc_md4600"></a></p><h5>.compile(Object schema) -&gt; Function&lt;Object data&gt;</h5>
<p>Generate validating function and cache the compiled schema for future use.</p>
<p>Validating function returns a boolean value. This function has properties <code>errors</code> and <code>schema</code>. <a class="el" href="class_errors.html">Errors</a> encountered during the last validation are assigned to <code>errors</code> property (it is assigned <code>null</code> if there was no errors). <code>schema</code> property contains the reference to the original schema.</p>
...
<p><a class="anchor" id="autotoc_md4601"></a></p><h5><a class="anchor" id="api-compileAsync"></a>.compileAsync(Object schema [, Boolean meta] [, Function callback]) -&gt; Promise</h5>
...
<p><a class="anchor" id="autotoc_md4602"></a></p><h5>.validate(Object schema|String key|String ref, data) -&gt; Boolean</h5>
...
<p><a class="anchor" id="autotoc_md4603"></a></p><h5>.addSchema(Array&lt;Object&gt;|Object schema [, String key]) -&gt; Ajv</h5>
...
</div><!-- fragment --><p><a class="anchor" id="autotoc_md4604"></a></p><h5>.addMetaSchema(Array&lt;Object&gt;|Object schema [, String key]) -&gt; Ajv</h5>
...
<p><a class="anchor" id="autotoc_md4605"></a></p><h5><a class="anchor" id="api-validateschema"></a>.validateSchema(Object schema) -&gt; Boolean</h5>
...
<p><a class="el" href="class_errors.html">Errors</a> will be available at <code>ajv.errors</code>.</p>
<p><a class="anchor" id="autotoc_md4606"></a></p><h5>.getSchema(String key) -&gt; Function&lt;Object data&gt;</h5>
...
<p><a class="anchor" id="autotoc_md4607"></a></p><h5>.removeSchema([Object schema|String key|String ref|RegExp pattern]) -&gt; Ajv</h5>
...
<p><a class="anchor" id="autotoc_md4608"></a></p><h5><a class="anchor" id="api-addformat"></a>.addFormat(String name, String|RegExp|Function|Object format) -&gt; Ajv</h5>
...
<p><a class="anchor" id="autotoc_md4609"></a></p><h5><a class="anchor" id="api-addkeyword"></a>.addKeyword(String keyword, Object definition) -&gt; Ajv</h5>
...
<p><a class="anchor" id="autotoc_md4610"></a></p><h5>.getKeyword(String keyword) -&gt; Object|Boolean</h5>
...
<p><a class="anchor" id="autotoc_md4611"></a></p><h5>.removeKeyword(String keyword) -&gt; Ajv</h5>
...
<p><a class="anchor" id="autotoc_md4612"></a></p><h5>.errorsText([Array&lt;Object&gt; errors [, Object options]]) -&gt; String</h5>
...
<h2><a class="anchor" id="autotoc_md4613"></a>
Options</h2>
<p>Defaults:</p>
<div class="fragment"><div class="line">{</div>
...
<div class="line">  strictNumbers:    false,</div>
...
<div class="line">  processCode:      undefined, // function (str: string, schema: object): string {}</div>
<div class="line">  cache:            new Cache,</div>
<div class="line">  serialize:        undefined</div>
<div class="line">}</div>
</div><!-- fragment --><p><a class="anchor" id="autotoc_md4614"></a></p><h5>Validation and reporting options</h5>
<ul>
...
<p><a class="anchor" id="autotoc_md4615"></a></p><h5>Referenced schema options</h5>
<ul>
...
<p><a class="anchor" id="autotoc_md4616"></a></p><h5>Options to modify validated data</h5>
<ul>
...
<li><em>coerceTypes</em>: change data type of data to match <code>type</code> keyword. See the example in <a href="#coercing-data-types">Coercing data types</a> and <a href="https://github.com/ajv-validator/ajv/blob/master/COERCION.md">coercion rules</a>. Option values:<ul>
...
<p><a class="anchor" id="autotoc_md4617"></a></p><h5>Strict mode options</h5>
<ul>
...
<p><a class="anchor" id="autotoc_md4618"></a></p><h5>Asynchronous validation options</h5>
<ul>
<li><em>transpile</em>: Requires <a href="https://github.com/ajv-validator/ajv-async">ajv-async</a> package. It determines whether Ajv transpiles compiled asynchronous validation function. Option values:<ul>
...
<p><a class="anchor" id="autotoc_md4619"></a></p><h5>Advanced options</h5>
<ul>
...
<li><code>beautify</code> that formatted the generated function using <a href="https://github.com/beautify-web/js-beautify">js-beautify</a>. If you want to beautify the generated code pass a function calling &lsquo;require('js-beautify&rsquo;).js_beautify<code>as</code>processCode: code =&gt; js_beautify(code)<code>. -</code>transpile<code>that transpiled asynchronous validation function. You can still use</code>transpile<code>option with [ajv-async](<a href="https://github.com/ajv-validator/ajv-async">https://github.com/ajv-validator/ajv-async</a>) package. See [Asynchronous validation](#asynchronous-validation) for more information.</code></li>
</ul>
</li>
...
<h2><a class="anchor" id="autotoc_md4620"></a>
...
<h3><a class="anchor" id="autotoc_md4621"></a>
Error objects</h3>
...
<h3><a class="anchor" id="autotoc_md4622"></a>
Error parameters</h3>
...
<h3><a class="anchor" id="autotoc_md4623"></a>
Error logging</h3>
...
<div class="line">  }</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md4624"></a>
Plugins</h2>
...
<h2><a class="anchor" id="autotoc_md4629"></a>
Changes history</h2>
<p>See <a href="https://github.com/ajv-validator/ajv/releases">https://github.com/ajv-validator/ajv/releases</a></p>
<p><b>Please note</b>: <a href="https://github.com/ajv-validator/ajv/releases/tag/v7.0.0-beta.0">Changes in version 7.0.0-beta</a></p>
...
<p>Please report any unacceptable behaviour to <a href="#" onclick="location.href='mai'+'lto:'+'ajv'+'.v'+'ali'+'da'+'tor'+'@g'+'mai'+'l.'+'com'; return false;">ajv.v<span style="display: none;">.nosp@m.</span>alid<span style="display: none;">.nosp@m.</span>ator@<span style="display: none;">.nosp@m.</span>gmai<span style="display: none;">.nosp@m.</span>l.com</a> - it will be reviewed by the project team.</p>
<h2><a class="anchor" id="autotoc_md4631"></a>
...
<h2><a class="anchor" id="autotoc_md4632"></a>
License</h2>
