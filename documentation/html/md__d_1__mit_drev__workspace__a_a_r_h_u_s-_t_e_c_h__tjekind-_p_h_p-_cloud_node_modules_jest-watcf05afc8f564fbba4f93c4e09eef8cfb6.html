...
<title>Tjekind PHP Cloud: &lt;img src=&quot;media/header.png&quot; width=&quot;1000&quot;&gt;</title>
...
<div class="title"><img src="media/header.png" alt="" width="1000" class="inline"/> </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><blockquote class="doxtable">
<p>Simple and modern async event emitter </p>
</blockquote>
<p><a href="https://codecov.io/gh/sindresorhus/emittery"><object type="image/svg+xml" data="https://codecov.io/gh/sindresorhus/emittery/branch/main/graph/badge.svg" style="pointer-events: none;">Coverage Status</object></a> <a href="https://bundlephobia.com/result?p=emittery"><img src="https://badgen.net/bundlephobia/minzip/emittery" alt="" class="inline"/></a></p>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md14613"></a>
Usage</h1>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md14614"></a>
API</h1>
<h2><a class="anchor" id="autotoc_md14615"></a>
eventName</h2>
...
<h2><a class="anchor" id="autotoc_md14616"></a>
isDebugEnabled</h2>
...
<div class="line">//  data: undefined</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md14617"></a>
emitter = new Emittery(options?)</h2>
<p>Create a new instance of Emittery.</p>
<h3><a class="anchor" id="autotoc_md14618"></a>
options?</h3>
<p>Type: <code>object</code></p>
<p>Configure the new instance of Emittery.</p>
<h4><a class="anchor" id="autotoc_md14619"></a>
debug?</h4>
<p>Type: <code>object</code></p>
...
<div class="line">    }</div>
<div class="line"> </div>
<div class="line">    if (typeof eventName === &#39;symbol&#39;) {</div>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md14620"></a>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md14621"></a>
...
<div class="line">});</div>
</div><!-- fragment --><h5>Listener data</h5>
<ul>
...
<h4><a class="anchor" id="autotoc_md14622"></a>
listener(data)</h4>
<h3><a class="anchor" id="autotoc_md14623"></a>
...
<div class="line">})();</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md14624"></a>
listener(data)</h4>
<h3><a class="anchor" id="autotoc_md14625"></a>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md14626"></a>
events(eventName)</h3>
...
<div class="line">        // done === true</div>
<div class="line">    });</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md14627"></a>
...
<h3><a class="anchor" id="autotoc_md14628"></a>
...
<h3><a class="anchor" id="autotoc_md14629"></a>
onAny(listener)</h3>
<p>Subscribe to be notified about any event.</p>
<p>Returns a method to unsubscribe.</p>
<h4><a class="anchor" id="autotoc_md14630"></a>
listener(eventName, data)</h4>
<h3><a class="anchor" id="autotoc_md14631"></a>
offAny(listener)</h3>
<p>Remove an <code>onAny</code> subscription.</p>
<h3><a class="anchor" id="autotoc_md14632"></a>
anyEvent()</h3>
...
<div class="line">        // done === true</div>
<div class="line">    });</div>
</div><!-- fragment --><p>In the same way as for <code>events</code>, you can subscribe by using the <code>for await</code> statement</p>
<h3><a class="anchor" id="autotoc_md14633"></a>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md14636"></a>
TypeScript</h1>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md14637"></a>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md14638"></a>
...
<h1><a class="anchor" id="autotoc_md14639"></a>
Debugging</h1>
...
How is this different than the built-in &lt;tt&gt;EventEmitter&lt;/tt&gt; in Node.js?</h2>
...
Isn't &lt;tt&gt;EventEmitter&lt;/tt&gt; synchronous for a reason?</h2>
...
Can you support multiple arguments for &lt;tt&gt;emit()&lt;/tt&gt;?</h2>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md14644"></a>
Related</h1>
<ul>
