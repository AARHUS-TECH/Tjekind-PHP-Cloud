...
<title>Tjekind PHP Cloud: minimatch</title>
...
<p><a href="http://travis-ci.org/isaacs/minimatch"><object type="image/svg+xml" data="https://travis-ci.org/isaacs/minimatch.svg?branch=master" style="pointer-events: none;">Build Status</object></a></p>
...
<h1><a class="anchor" id="autotoc_md11530"></a>
Usage</h1>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md11531"></a>
Features</h1>
...
<h1><a class="anchor" id="autotoc_md11532"></a>
Windows</h1>
...
<h1><a class="anchor" id="autotoc_md11533"></a>
Minimatch Class</h1>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md11534"></a>
Properties</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md11535"></a>
Methods</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md11536"></a>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md11537"></a>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md11538"></a>
...
<h2><a class="anchor" id="autotoc_md11545"></a>
noext</h2>
<p>Disable "extglob" style patterns like <code>+(a|b)</code>.</p>
<h2><a class="anchor" id="autotoc_md11546"></a>
nocase</h2>
<p>Perform a case-insensitive match.</p>
<h2><a class="anchor" id="autotoc_md11547"></a>
nonull</h2>
...
<h2><a class="anchor" id="autotoc_md11548"></a>
matchBase</h2>
...
<h2><a class="anchor" id="autotoc_md11552"></a>
partial</h2>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md11553"></a>
windowsPathsNoEscape</h2>
<p>Use <code>\\</code> as a path separator <em>only</em>, and <em>never</em> as an escape character. If set, all <code>\\</code> characters are replaced with <code>/</code> in the pattern. Note that this makes it <b>impossible</b> to match against paths containing literal glob pattern characters, but allows matching with patterns constructed using <code>path.join()</code> and <code>path.resolve()</code> on Windows platforms, mimicking the (buggy!) behavior of earlier versions on Windows. Please use with caution, and be mindful of <a href="#windows">the caveat about Windows paths</a>.</p>
<p>For legacy reasons, this is also set if <code>options.allowWindowsEscape</code> is set to the exact value <code>false</code>.</p>
<h1><a class="anchor" id="autotoc_md11554"></a>
