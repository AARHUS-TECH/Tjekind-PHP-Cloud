...
<div class="contents">
<div class="textblock"><h1 align="center"><object type="image/svg+xml" data="logo.svg" style="pointer-events: none;" width="100" height="100"></object><br  />
 jsdom </h1>
...
Basic usage</h2>
<div class="fragment"><div class="line">const jsdom = require(&quot;jsdom&quot;);</div>
<div class="line">const { JSDOM } = jsdom;</div>
</div><!-- fragment --><p>To use jsdom, you will primarily use the <code>JSDOM</code> constructor, which is a named export of the jsdom main module. Pass the constructor a string. You will get back a <code>JSDOM</code> object, which has a number of useful properties, notably <code>window</code>:</p>
<div class="fragment"><div class="line">const dom = new JSDOM(`&lt;!DOCTYPE html&gt;&lt;p&gt;Hello world&lt;/p&gt;`);</div>
<div class="line">console.log(dom.window.document.querySelector(&quot;p&quot;).textContent); // &quot;Hello world&quot;</div>
</div><!-- fragment --><p>(Note that jsdom will parse the HTML you pass it just like a browser does, including implied <code>&lt;html&gt;</code>, <code>&lt;head&gt;</code>, and <code>&lt;body&gt;</code> tags.)</p>
...
<div class="fragment"><div class="line">const { window } = new JSDOM(`...`);</div>
<div class="line">// or even</div>
<div class="line">const { document } = (new JSDOM(`...`)).window;</div>
</div><!-- fragment --><p>Full documentation on everything you can do with the <code>JSDOM</code> class is below, in the section "`JSDOM` Object API".</p>
<h2><a class="anchor" id="autotoc_md15002"></a>
Customizing jsdom</h2>
...
<h3><a class="anchor" id="autotoc_md15003"></a>
Simple options</h3>
<div class="fragment"><div class="line">const dom = new JSDOM(``, {</div>
<div class="line">  url: &quot;https://example.org/&quot;,</div>
<div class="line">  referrer: &quot;https://example.com/&quot;,</div>
<div class="line">  contentType: &quot;text/html&quot;,</div>
<div class="line">  includeNodeLocations: true,</div>
<div class="line">  storageQuota: 10000000</div>
<div class="line">});</div>
</div><!-- fragment --><ul>
...
<h3><a class="anchor" id="autotoc_md15004"></a>
Executing scripts</h3>
...
<div class="fragment"><div class="line">const dom = new JSDOM(`&lt;body&gt;</div>
<div class="line">  &lt;script&gt;document.body.appendChild(document.createElement(&quot;hr&quot;));&lt;/script&gt;</div>
<div class="line">&lt;/body&gt;`);</div>
<div class="line"> </div>
<div class="line">// The script will not be executed, by default:</div>
<div class="line">dom.window.document.body.children.length === 1;</div>
</div><!-- fragment --><p>To enable executing scripts inside the page, you can use the <code>runScripts: "dangerously"</code> option:</p>
<div class="fragment"><div class="line">const dom = new JSDOM(`&lt;body&gt;</div>
<div class="line">  &lt;script&gt;document.body.appendChild(document.createElement(&quot;hr&quot;));&lt;/script&gt;</div>
<div class="line">&lt;/body&gt;`, { runScripts: &quot;dangerously&quot; });</div>
<div class="line"> </div>
<div class="line">// The script will be executed and modify the DOM:</div>
<div class="line">dom.window.document.body.children.length === 2;</div>
</div><!-- fragment --><p>Again we emphasize to only use this when feeding jsdom code you know is safe. If you use it on arbitrary user-supplied code, or code from the Internet, you are effectively running untrusted Node.js code, and your machine could be compromised.</p>
<p>If you want to execute <em>external</em> scripts, included via <code>&lt;script src=""&gt;</code>, you'll also need to ensure that they load them. To do this, add the option <code>resources: "usable"</code> <a href="#loading-subresources">as described below</a>. (You'll likely also want to set the <code>url</code> option, for the reasons discussed there.)</p>
...
<div class="fragment"><div class="line">const { window } = new JSDOM(``, { runScripts: &quot;outside-only&quot; });</div>
<div class="line"> </div>
<div class="line">window.eval(`document.body.innerHTML = &quot;&lt;p&gt;Hello, world!&lt;/p&gt;&quot;;`);</div>
<div class="line">window.document.body.children.length === 1;</div>
</div><!-- fragment --><p>This is turned off by default for performance reasons, but is safe to enable.</p>
...
<h3><a class="anchor" id="autotoc_md15005"></a>
Pretending to be a visual browser</h3>
...
<div class="fragment"><div class="line">const window = (new JSDOM(``, { pretendToBeVisual: true })).window;</div>
<div class="line"> </div>
<div class="line">window.requestAnimationFrame(timestamp =&gt; {</div>
<div class="line">  console.log(timestamp &gt; 0);</div>
<div class="line">});</div>
</div><!-- fragment --><p>Note that jsdom still <a href="#unimplemented-parts-of-the-web-platform">does not do any layout or rendering</a>, so this is really just about <em>pretending</em> to be visual, not about implementing the parts of the platform a real, visual web browser would implement.</p>
<h3><a class="anchor" id="autotoc_md15006"></a>
Loading subresources</h3>
<h4><a class="anchor" id="autotoc_md15007"></a>
Basic options</h4>
...
<li>Images, via <code>&lt;img&gt;</code>, but only if the <code>canvas</code> npm package is also installed (see "[Canvas Support](#canvas-support)" below)</li>
</ul>
<p>When attempting to load resources, recall that the default value for the <code>url</code> option is <code>"about:blank"</code>, which means that any resources included via relative URLs will fail to load. (The result of trying to parse the URL <code>/something</code> against the URL <code>about:blank</code> is an error.) So, you'll likely want to set a non-default value for the <code>url</code> option in those cases, or use one of the <a href="#convenience-apis">convenience APIs</a> that do so automatically.</p>
<h4><a class="anchor" id="autotoc_md15008"></a>
...
<div class="fragment"><div class="line">const resourceLoader = new jsdom.ResourceLoader({</div>
<div class="line">  proxy: &quot;http://127.0.0.1:9001&quot;,</div>
<div class="line">  strictSSL: false,</div>
<div class="line">  userAgent: &quot;Mellblomenator/9000&quot;,</div>
<div class="line">});</div>
<div class="line">const dom = new JSDOM(``, { resources: resourceLoader });</div>
</div><!-- fragment --><p>The three options to the <code>ResourceLoader</code> constructor are:</p>
<ul>
...
<div class="fragment"><div class="line">class CustomResourceLoader extends jsdom.ResourceLoader {</div>
<div class="line">  fetch(url, options) {</div>
<div class="line">    // Override the contents of this script to do something unusual.</div>
<div class="line">    if (url === &quot;https://example.com/some-specific-script.js&quot;) {</div>
<div class="line">      return Promise.resolve(Buffer.from(&quot;window.someGlobal = 5;&quot;));</div>
<div class="line">    }</div>
<div class="line"> </div>
<div class="line">    return super.fetch(url, options);</div>
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><p>jsdom will call your custom resource loader's <code>fetch()</code> method whenever it encounters a "usable" resource, per the above section. The method takes a URL string, as well as a few options which you should pass through unmodified if calling <code>super.fetch()</code>. It must return a promise for a Node.js <code>Buffer</code> object, or return <code>null</code> if the resource is intentionally not to be loaded. In general, most cases will want to delegate to <code>super.fetch()</code>, as shown.</p>
<p>One of the options you will receive in <code>fetch()</code> will be the element (if applicable) that is fetching a resource.</p>
<div class="fragment"><div class="line">class CustomResourceLoader extends jsdom.ResourceLoader {</div>
<div class="line">  fetch(url, options) {</div>
<div class="line">    if (options.element) {</div>
<div class="line">      console.log(`Element ${options.element.localName} is requesting the url ${url}`);</div>
<div class="line">    }</div>
<div class="line"> </div>
<div class="line">    return super.fetch(url, options);</div>
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15009"></a>
Virtual consoles</h3>
...
<div class="fragment"><div class="line">const virtualConsole = new jsdom.VirtualConsole();</div>
<div class="line">const dom = new JSDOM(``, { virtualConsole });</div>
</div><!-- fragment --><p>Code like this will create a virtual console with no behavior. You can give it behavior by adding event listeners for all the possible console methods:</p>
<div class="fragment"><div class="line">virtualConsole.on(&quot;error&quot;, () =&gt; { ... });</div>
<div class="line">virtualConsole.on(&quot;warn&quot;, () =&gt; { ... });</div>
<div class="line">virtualConsole.on(&quot;info&quot;, () =&gt; { ... });</div>
<div class="line">virtualConsole.on(&quot;dir&quot;, () =&gt; { ... });</div>
<div class="line">// ... etc. See https://console.spec.whatwg.org/#logging</div>
</div><!-- fragment --><p>(Note that it is probably best to set up these event listeners <em>before</em> calling <code>new JSDOM()</code>, since errors or console-invoking script might occur during parsing.)</p>
<p>If you simply want to redirect the virtual console output to another console, like the default Node.js one, you can do</p>
<div class="fragment"><div class="line">virtualConsole.sendTo(console);</div>
...
<ul>
<li><a class="el" href="class_errors.html">Errors</a> loading or parsing subresources (scripts, stylesheets, frames, and iframes)</li>
...
<div class="fragment"><div class="line">virtualConsole.sendTo(c, { omitJSDOMErrors: true });</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15010"></a>
Cookie jars</h3>
...
<div class="fragment"><div class="line">const cookieJar = new jsdom.CookieJar(store, options);</div>
<div class="line">const dom = new JSDOM(``, { cookieJar });</div>
</div><!-- fragment --><p>This is mostly useful if you want to share the same cookie jar among multiple jsdoms, or prime the cookie jar with certain values ahead of time.</p>
...
<h3><a class="anchor" id="autotoc_md15011"></a>
Intervening before parsing</h3>
...
<div class="fragment"><div class="line">const dom = new JSDOM(`&lt;p&gt;Hello&lt;/p&gt;`, {</div>
<div class="line">  beforeParse(window) {</div>
<div class="line">    window.document.childNodes.length === 0;</div>
<div class="line">    window.someCoolAPI = () =&gt; { /* ... */ };</div>
<div class="line">  }</div>
<div class="line">});</div>
</div><!-- fragment --><p>This is especially useful if you are wanting to modify the environment in some way, for example adding shims for web platform APIs jsdom does not support.</p>
<h2><a class="anchor" id="autotoc_md15012"></a>
&lt;tt&gt;JSDOM&lt;/tt&gt; object API</h2>
<p>Once you have constructed a <code>JSDOM</code> object, it will have the following useful capabilities:</p>
<h3><a class="anchor" id="autotoc_md15013"></a>
Properties</h3>
...
<h3><a class="anchor" id="autotoc_md15014"></a>
Serializing the document with &lt;tt&gt;serialize()&lt;/tt&gt;</h3>
...
<div class="fragment"><div class="line">const dom = new JSDOM(`&lt;!DOCTYPE html&gt;hello`);</div>
<div class="line"> </div>
<div class="line">dom.serialize() === &quot;&lt;!DOCTYPE html&gt;&lt;html&gt;&lt;head&gt;&lt;/head&gt;&lt;body&gt;hello&lt;/body&gt;&lt;/html&gt;&quot;;</div>
<div class="line"> </div>
<div class="line">// Contrast with:</div>
<div class="line">dom.window.document.documentElement.outerHTML === &quot;&lt;html&gt;&lt;head&gt;&lt;/head&gt;&lt;body&gt;hello&lt;/body&gt;&lt;/html&gt;&quot;;</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15015"></a>
Getting the source location of a node with &lt;tt&gt;nodeLocation(node)&lt;/tt&gt;</h3>
...
<div class="fragment"><div class="line">const dom = new JSDOM(</div>
<div class="line">  `&lt;p&gt;Hello</div>
<div class="line">    &lt;img src=&quot;foo.jpg&quot;&gt;</div>
<div class="line">  &lt;/p&gt;`,</div>
<div class="line">  { includeNodeLocations: true }</div>
<div class="line">);</div>
<div class="line"> </div>
<div class="line">const document = dom.window.document;</div>
<div class="line">const bodyEl = document.body; // implicitly created</div>
<div class="line">const pEl = document.querySelector(&quot;p&quot;);</div>
<div class="line">const textNode = pEl.firstChild;</div>
<div class="line">const imgEl = document.querySelector(&quot;img&quot;);</div>
<div class="line"> </div>
<div class="line">console.log(dom.nodeLocation(bodyEl));   // null; it&#39;s not in the source</div>
<div class="line">console.log(dom.nodeLocation(pEl));      // { startOffset: 0, endOffset: 39, startTag: ..., endTag: ... }</div>
<div class="line">console.log(dom.nodeLocation(textNode)); // { startOffset: 3, endOffset: 13 }</div>
<div class="line">console.log(dom.nodeLocation(imgEl));    // { startOffset: 13, endOffset: 32 }</div>
</div><!-- fragment --><p>Note that this feature only works if you have set the <code>includeNodeLocations</code> option; node locations are off by default for performance reasons.</p>
<h3><a class="anchor" id="autotoc_md15016"></a>
Interfacing with the Node.js &lt;tt&gt;vm&lt;/tt&gt; module using &lt;tt&gt;getInternalVMContext()&lt;/tt&gt;</h3>
...
<p>```js const { Script } = require("vm");</p>
<p>const dom = new JSDOM(`<code>, { runScripts: "outside-only" }); const script = new Script(</code> if (!this.ran) { this.ran = 0; }</p>
<p>++this.ran; `);</p>
<p>const vmContext = dom.getInternalVMContext();</p>
<p>script.runInContext(vmContext); script.runInContext(vmContext); script.runInContext(vmContext);</p>
<p>console.assert(dom.window.ran === 3); ```</p>
...
<p>Note that this method will throw an exception if the <code>JSDOM</code> instance was created without <code>runScripts</code> set, or if you are <a href="#running-jsdom-inside-a-web-browser">using jsdom in a web browser</a>.</p>
<h3><a class="anchor" id="autotoc_md15017"></a>
Reconfiguring the jsdom with &lt;tt&gt;reconfigure(settings)&lt;/tt&gt;</h3>
...
<div class="fragment"><div class="line">const dom = new JSDOM();</div>
<div class="line"> </div>
<div class="line">dom.window.top === dom.window;</div>
<div class="line">dom.window.location.href === &quot;about:blank&quot;;</div>
<div class="line"> </div>
<div class="line">dom.reconfigure({ windowTop: myFakeTopForTesting, url: &quot;https://example.com/&quot; });</div>
<div class="line"> </div>
<div class="line">dom.window.top === myFakeTopForTesting;</div>
<div class="line">dom.window.location.href === &quot;https://example.com/&quot;;</div>
</div><!-- fragment --><p>Note that changing the jsdom's URL will impact all APIs that return the current document URL, such as <code>window.location</code>, <code>document.URL</code>, and <code>document.documentURI</code>, as well as the resolution of relative URLs within the document, and the same-origin checks and referrer used while fetching subresources. It will not, however, perform navigation to the contents of that URL; the contents of the DOM will remain unchanged, and no new instances of <code>Window</code>, <code>Document</code>, etc. will be created.</p>
<h2><a class="anchor" id="autotoc_md15018"></a>
Convenience APIs</h2>
<h3><a class="anchor" id="autotoc_md15019"></a>
&lt;tt&gt;fromURL()&lt;/tt&gt;</h3>
...
<div class="fragment"><div class="line">JSDOM.fromURL(&quot;https://example.com/&quot;, options).then(dom =&gt; {</div>
<div class="line">  console.log(dom.serialize());</div>
<div class="line">});</div>
</div><!-- fragment --><p>The returned promise will fulfill with a <code>JSDOM</code> instance if the URL is valid and the request is successful. Any redirects will be followed to their ultimate destination.</p>
...
<h3><a class="anchor" id="autotoc_md15020"></a>
&lt;tt&gt;fromFile()&lt;/tt&gt;</h3>
...
<div class="fragment"><div class="line">JSDOM.fromFile(&quot;stuff.html&quot;, options).then(dom =&gt; {</div>
<div class="line">  console.log(dom.serialize());</div>
<div class="line">});</div>
</div><!-- fragment --><p>The returned promise will fulfill with a <code>JSDOM</code> instance if the given file can be opened. As usual in Node.js APIs, the filename is given relative to the current working directory.</p>
...
<h3><a class="anchor" id="autotoc_md15021"></a>
&lt;tt&gt;fragment()&lt;/tt&gt;</h3>
...
<div class="fragment"><div class="line">const frag = JSDOM.fragment(`&lt;p&gt;Hello&lt;/p&gt;`);</div>
<div class="line">console.log(frag.firstChild.outerHTML); // logs &quot;&lt;p&gt;Hello&lt;/p&gt;&quot;</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md15022"></a>
Other noteworthy features</h2>
<h3><a class="anchor" id="autotoc_md15023"></a>
Canvas support</h3>
...
<h3><a class="anchor" id="autotoc_md15024"></a>
...
<h3><a class="anchor" id="autotoc_md15025"></a>
Closing down a jsdom</h3>
...
<h3><a class="anchor" id="autotoc_md15026"></a>
Running jsdom inside a web browser</h3>
...
<h3><a class="anchor" id="autotoc_md15027"></a>
Debugging the DOM using Chrome Devtools</h3>
...
Caveats</h2>
<h3><a class="anchor" id="autotoc_md15029"></a>
Asynchronous script loading</h3>
...
<div class="fragment"><div class="line">// On the Node.js side:</div>
<div class="line">const window = (new JSDOM(...)).window;</div>
<div class="line">window.onModulesLoaded = () =&gt; {</div>
<div class="line">  console.log(&quot;ready to roll!&quot;);</div>
<div class="line">};</div>
</div><!-- fragment --><div class="fragment"><div class="line">&lt;!-- Inside the HTML you supply to jsdom --&gt;</div>
<div class="line">&lt;script&gt;</div>
<div class="line">requirejs([&quot;entry-module&quot;], () =&gt; {</div>
<div class="line">  window.onModulesLoaded();</div>
<div class="line">});</div>
<div class="line">&lt;/script&gt;</div>
</div><!-- fragment --><p>If you do not control the page, you could try workarounds such as polling for the presence of a specific element.</p>
...
<h3><a class="anchor" id="autotoc_md15030"></a>
Unimplemented parts of the web platform</h3>
...
<ul>
<li><b>Navigation</b>: the ability to change the global object, and all other objects, when clicking a link or assigning <code>location.href</code> or similar.</li>
<li><b>Layout</b>: the ability to calculate where elements will be visually laid out as a result of CSS, which impacts methods like <code>getBoundingClientRects()</code> or properties like <code>offsetTop</code>.</li>
</ul>
...
<h2><a class="anchor" id="autotoc_md15031"></a>
Supporting jsdom</h2>
...
<h2><a class="anchor" id="autotoc_md15032"></a>
Getting help</h2>
<p>If you need help with jsdom, please feel free to use any of the following venues:</p>
<ul>
<li>The <a href="https://groups.google.com/group/jsdom">mailing list</a> (best for "how do I" questions)</li>
