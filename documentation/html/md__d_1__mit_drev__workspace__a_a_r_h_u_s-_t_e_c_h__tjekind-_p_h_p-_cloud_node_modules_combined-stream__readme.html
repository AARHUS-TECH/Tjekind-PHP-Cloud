...
<title>Tjekind PHP Cloud: combined-stream</title>
...
<p><b>NB</b> Currently <code>combined-stream</code> works with streams version 1 only. There is ongoing effort to switch this library to streams version 2. Any help is welcome. :) Meanwhile you can explore other libraries that provide streams2 support with more or less compatibility with <code>combined-stream</code>.</p>
<ul>
...
<h1><a class="anchor" id="autotoc_md6625"></a>
Installation</h1>
<div class="fragment"><div class="line">npm install combined-stream</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md6626"></a>
Usage</h1>
<p>Here is a simple example that shows how you can use combined-stream to combine two files into one:</p>
<div class="fragment"><div class="line">var CombinedStream = require(&#39;combined-stream&#39;);</div>
...
<div class="line"> </div>
<div class="line">combinedStream.pipe(fs.createWriteStream(&#39;combined.txt&#39;));</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md6627"></a>
API</h1>
...
<h2><a class="anchor" id="autotoc_md6629"></a>
combinedStream.pauseStreams = &lt;tt&gt;true&lt;/tt&gt;</h2>
...
combinedStream.maxDataSize = &lt;tt&gt;2 * 1024 * 1024&lt;/tt&gt;</h2>
...
combinedStream.dataSize = &lt;tt&gt;0&lt;/tt&gt;</h2>
...
<h2><a class="anchor" id="autotoc_md6634"></a>
...
<h2><a class="anchor" id="autotoc_md6635"></a>
...
<h2><a class="anchor" id="autotoc_md6636"></a>
...
<h2><a class="anchor" id="autotoc_md6637"></a>
...
<h1><a class="anchor" id="autotoc_md6638"></a>
License</h1>
