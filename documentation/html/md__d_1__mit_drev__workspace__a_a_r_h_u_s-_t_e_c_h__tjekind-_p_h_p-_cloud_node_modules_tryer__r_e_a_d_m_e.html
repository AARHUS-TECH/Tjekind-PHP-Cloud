...
<title>Tjekind PHP Cloud: tryer</title>
...
<div class="title">tryer </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><p><a href="https://gitlab.com/philbooth/tryer/pipelines"><object type="image/svg+xml" data="https://gitlab.com/philbooth/tryer/badges/master/pipeline.svg" style="pointer-events: none;">Build status</object></a> <a href="https://www.npmjs.com/package/tryer"><object type="image/svg+xml" data="https://img.shields.io/npm/v/tryer.svg" style="pointer-events: none;">Package status</object></a> <a href="https://www.npmjs.com/package/tryer"><object type="image/svg+xml" data="https://img.shields.io/npm/dm/tryer.svg" style="pointer-events: none;">Downloads</object></a> <a href="https://opensource.org/licenses/MIT"><object type="image/svg+xml" data="https://img.shields.io/npm/l/tryer.svg" style="pointer-events: none;">License</object></a></p>
...
<h1><a class="anchor" id="autotoc_md24029"></a>
Say what?</h1>
...
How do I use it?</h1>
<h2><a class="anchor" id="autotoc_md24033"></a>
...
Examples</h2>
<p>``<code>javascript // Attempt to insert a database record, waiting until</code>db.isConnected` // before doing so. The retry interval is 1 second on each iteration // and the call will fail after 10 attempts. tryer({ action: () =&gt; db.insert(record), when: () =&gt; db.isConnected, interval: 1000, limit: 10, fail () { log.error('No database connection, terminating.'); process.exit(1); } }); </p><div class="fragment"><div class="line">```javascript</div>
<div class="line">// Attempt to send an email message, optionally retrying with</div>
...
<div class="line">  limit: -1</div>
<div class="line">});</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md24036"></a>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md24037"></a>
