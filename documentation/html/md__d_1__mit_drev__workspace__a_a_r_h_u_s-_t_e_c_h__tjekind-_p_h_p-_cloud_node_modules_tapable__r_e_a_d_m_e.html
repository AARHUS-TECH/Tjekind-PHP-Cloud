...
<title>Tjekind PHP Cloud: Tapable</title>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md23566"></a>
Usage</h1>
...
<div class="fragment"><div class="line">class Car {</div>
<div class="line">    /**</div>
<div class="line">      * You won&#39;t get returned value from SyncHook or AsyncParallelHook,</div>
<div class="line">      * to do that, use SyncWaterfallHook and AsyncSeriesWaterfallHook respectively</div>
<div class="line">     **/</div>
<div class="line"> </div>
<div class="line">    setSpeed(newSpeed) {</div>
<div class="line">        // following call returns undefined even when you returned values</div>
...
<div class="line">        return this.hooks.calculateRoutes.promise(source, target, routesList).then((res) =&gt; {</div>
<div class="line">            // res is undefined for AsyncParallelHook</div>
...
<h1><a class="anchor" id="autotoc_md23567"></a>
Hook types</h1>
...
<li><b>Loop</b>. When a plugin in a loop hook returns a non-undefined value the hook will restart from the first plugin. It will loop until all plugins return undefined.</li>
</ul>
...
<h1><a class="anchor" id="autotoc_md23568"></a>
Interception</h1>
...
<h1><a class="anchor" id="autotoc_md23569"></a>
Context</h1>
...
<div class="line">    }</div>
<div class="line">});</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md23570"></a>
HookMap</h1>
...
</div><!-- fragment --><div class="fragment"><div class="line">keyedHook.for(&quot;some-key&quot;).tap(&quot;MyPlugin&quot;, (arg) =&gt; { /* ... */ });</div>
<div class="line">keyedHook.for(&quot;some-key&quot;).tapAsync(&quot;MyPlugin&quot;, (arg, callback) =&gt; { /* ... */ });</div>
<div class="line">keyedHook.for(&quot;some-key&quot;).tapPromise(&quot;MyPlugin&quot;, (arg) =&gt; { /* ... */ });</div>
...
<div class="line">}</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md23571"></a>
...
<div class="line">    context: boolean,</div>
<div class="line">    before?: string | Array</div>
<div class="line">}</div>
...
<div class="line">    for: (key: any) =&gt; Hook</div>
<div class="line">}</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md23572"></a>
MultiHook</h1>
