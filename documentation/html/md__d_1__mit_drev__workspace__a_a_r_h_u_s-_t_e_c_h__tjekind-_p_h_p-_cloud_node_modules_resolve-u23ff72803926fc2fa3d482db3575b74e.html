...
<title>Tjekind PHP Cloud: Advanced Features</title>
...
<div class="contents">
<div class="textblock"><p>Arguments</p>
<p>All the advanced features of this loader involve customising the <code>join</code> option.</p>
...
<h1><a class="anchor" id="autotoc_md19580"></a>
...
<p>⚠️ <b>IMPORTANT</b> - First read how the <a href="./how-it-works.md#algorithm">algorithm</a> works.</p>
...
<p>A custom <code>join</code> function from scratch is possible but we've provided some <a href="#building-blocks">building blocks</a> to make the task easier.</p>
<h1><a class="anchor" id="autotoc_md19581"></a>
Building blocks</h1>
...
<div class="line">});</div>
</div><!-- fragment --><p>🤓 If you have some very specific behaviour in mind you can specify your own implementation. This gives full control but still gives you <code>debug</code> logging for free.</p>
...
<p>👉 However its recommended to instead use <code>createJoinImplementation</code> to create the <code>implementation</code> using the <code>generator</code> concept.</p>
...
<h1><a class="anchor" id="autotoc_md19582"></a>
...
<li>returns an <code>Iterator</code> with elements of <code>[base:string,uri:string]</code> either intrinsically or by using <code>asGenerator</code>. &lt;/details&gt;</li>
</ul>
<p>&lt;details&gt;</p>
<p>FAQ </p>
<ul>
...
<p class="startli">If you prefer a less abstract approach consider a full <code>implementation</code> per the <a href="#full-customisation">full customisation</a> approach. &lt;/details&gt;</p>
</li>
</ul>
...
<p>⚠️ <b>IMPORTANT</b> - This example is indicative only and is <b>not</b> advised.</p>
...
<h1><a class="anchor" id="autotoc_md19588"></a>
...
<li><code>isFallback</code> indicates the asset was not found but that <code>joined</code> kis suitable as a fallback value &lt;/details&gt; </li>
</ul>
</li>
</ul>
</div></div><!-- contents -->
