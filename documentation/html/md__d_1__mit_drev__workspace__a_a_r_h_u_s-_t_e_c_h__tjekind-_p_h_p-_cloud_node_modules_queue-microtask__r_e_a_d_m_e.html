...
<div class="title">queue-microtask <a href="https://github.com/feross/queue-microtask/actions"><img src="https://img.shields.io/github/workflow/status/feross/queue-microtask/ci/master" alt="ci" class="inline"/></a> <a href="https://npmjs.org/package/queue-microtask"><object type="image/svg+xml" data="https://img.shields.io/npm/v/queue-microtask.svg" style="pointer-events: none;">npm</object></a> <a href="https://npmjs.org/package/queue-microtask"><object type="image/svg+xml" data="https://img.shields.io/npm/dm/queue-microtask.svg" style="pointer-events: none;">downloads</object></a> <a href="https://standardjs.com"><object type="image/svg+xml" data="https://img.shields.io/badge/code_style-standard-brightgreen.svg" style="pointer-events: none;">javascript style guide</object></a> </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><h2><a class="anchor" id="autotoc_md19070"></a>
fast, tiny &lt;a href="https://developer.mozilla.org/en-US/docs/Web/API/WindowOrWorkerGlobalScope/queueMicrotask"&gt;&lt;tt&gt;queueMicrotask&lt;/tt&gt;&lt;/a&gt; shim for modern engines</h2>
<ul>
...
<li>Optimal performance in all modern environments<ul>
...
<h1><a class="anchor" id="autotoc_md19071"></a>
install</h1>
<div class="fragment"><div class="line">npm install queue-microtask</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md19072"></a>
usage</h1>
<div class="fragment"><div class="line">const queueMicrotask = require(&#39;queue-microtask&#39;)</div>
<div class="line"> </div>
<div class="line">queueMicrotask(() =&gt; { /* this will run soon */ })</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md19073"></a>
What is &lt;tt&gt;queueMicrotask&lt;/tt&gt; and why would one use it?</h1>
...
<h1><a class="anchor" id="autotoc_md19074"></a>
Who is this package for?</h1>
...
<h1><a class="anchor" id="autotoc_md19075"></a>
Why not use &lt;tt&gt;process.nextTick&lt;/tt&gt;?</h1>
...
<h1><a class="anchor" id="autotoc_md19076"></a>
Why not use &lt;tt&gt;setTimeout(fn, 0)&lt;/tt&gt;?</h1>
...
<h1><a class="anchor" id="autotoc_md19077"></a>
Why not use a microtask library like &lt;a href="https://www.npmjs.com/package/immediate"&gt;&lt;tt&gt;immediate&lt;/tt&gt;&lt;/a&gt; or &lt;a href="https://www.npmjs.com/package/asap"&gt;&lt;tt&gt;asap&lt;/tt&gt;&lt;/a&gt;?</h1>
...
<p>Note: This package throws an exception in JS environments which lack <code>Promise</code> support &ndash; which are usually very old browsers and Node.js versions.</p>
<p>Since the <code>queueMicrotask</code> API is supported in Node.js, Chrome, Firefox, Safari, Opera, and Edge, <b>the vast majority of users will get optimal performance</b>. Any JS environment with <code>Promise</code>, which is almost all of them, also get optimal performance. If you need support for JS environments which lack <code>Promise</code> support, use one of the alternative packages.</p>
<h1><a class="anchor" id="autotoc_md19078"></a>
What is a shim?</h1>
...
<h1><a class="anchor" id="autotoc_md19079"></a>
API</h1>
<h2><a class="anchor" id="autotoc_md19080"></a>
&lt;tt&gt;queueMicrotask(fn)&lt;/tt&gt;</h2>
...
<h1><a class="anchor" id="autotoc_md19081"></a>
license</h1>
